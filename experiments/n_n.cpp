...
int main(){
    ...
    for(int i=0; i<100000; i++){
        ...
        /*
        inputVals.push_back(i2);
        inputVals.push_back(i3);
        inputVals.push_back(i4);
        */
        ...
        //cout<<endl<<"Input Values: ";
        //for(int i=0; i<inputVals.size(); i++) cout<<inputVals[i]<<" ";
        ...
        /*
        cout<<endl<<"Target Values: ";
        for(int i=0; i<targetVals.size(); i++) cout<<targetVals[i]<<" ";

        cout<<"Result Values: ";
        for(int i=0; i<resultVals.size(); i++) cout<<resultVals[i]<<" ";
