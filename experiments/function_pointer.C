/* Textbook Program from "Computer Science From The Bottom Up" */
/* This program gives the idea about how abstraction is achieved in C code bases using function pointers */
#include <stdio.h>
